    ...
    render() {
        ...
        return (
            ...
            >
             ...
             <TouchableOpacity style={{height: 50, width: '50%', justifyContent: 'center', borderBottomStartRadius: 10, borderBottomEndRadius: 0, backgroundColor: myTheme['color-info-800']}}
            ...
            <Text style={{color: '#fff', textAlign: 'center', fontWeight: 'bold', fontSize: 15}}>{textCancel}</Text>
                    ...
                    <TouchableOpacity style={{height: 50, width: '50%', justifyContent: 'center', borderBottomStartRadius: 0, borderBottomEndRadius: 10, backgroundColor: 'red'}}
             onPress={onPressOK}
             >
                <View style={{alignItems: 'center',justifyContent:'center'}}>
